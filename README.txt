...
Краткое описание:
Приложение представляет из себя базовый мессенжер со следующими функциями:
...
5) WebSocket-функционал групповых чатов: сделан на основе "идеологии комнат" (rooms).
